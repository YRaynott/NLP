...
# 訓練 Random Forest 最終模型
rf_model.fit(X_vectorized, y_train_full)
...
# 輸出 Random Forest 測試結果
test_data['predicted_catid_rf'] = y_test_pred_rf
test_data.to_json('test_data_predictions_rf.json', orient='records', lines=True)
